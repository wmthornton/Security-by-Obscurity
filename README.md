...
make install-mac: Compiles macOS executable and installs to /opt/local/bin directory. Also creates tmp directory.

make remove-mac: Removes macOS executable and tmp directory from system.

make clean-mac: Removes macOS executable from source directory and regenerates tmp directory. Does not remove executable from /opt/local/bin directory.